...
\DIFaddbegin \begin{figure}[h!]
    ...
    \caption{\DIFaddFL{Illustration of the ground truth visibility score computation process. (a) The input RGB image. (b) The projected 2D object mask overlaid with the hand mask, showing the occluded regions caused by the hand. (c) The projected 2D object mask without considering the hand, representing the total object pixels. The visibility score is computed as the ratio of visible object pixels in (b) to the total object pixels in (c).}}
