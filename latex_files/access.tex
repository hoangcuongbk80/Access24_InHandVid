...
\uppercase{Duc-Manh Nguyen}\authorrefmark{2},
\uppercase{Viet-Anh Trinh}\authorrefmark{2},
\uppercase{Nguyen Dinh Bao Long}\authorrefmark{2}, AND
\uppercase{Quang-Huy Ha}\authorrefmark{2}}
